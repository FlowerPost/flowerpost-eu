...
export const Route = createFileRoute("/biskvitki")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Какви бисквитки използва FLOWERPOST и как да управляваш съгласието си.",
      },
  ...
  return (
    <>
      <PageHeader
        ...
        intro={
          "Използваме минимален набор бисквитки. Аналитични и маркетингови се зареждат само след изрично съгласие."
        }
      />
      <Prose>
        <h2>Необходими бисквитки</h2>
        <p>
          Осигуряват работата на количката и сигурността на формите. Не могат да бъдат изключени.
        </p>
        ...
        <p>
          Използват се за измерване на кампании и ремаркетинг. Зареждат се само при дадено съгласие.
        </p>
        <h2>Управление на съгласието</h2>
        <p>
          Можеш да промениш избора си по всяко време, като изчистиш данните на сайта в браузъра си и
          презаредиш страницата.
        </p>
      </Prose>
    </>
  );
